...
var AddIcecreamForm = function (_React$Component) {
	_inherits(AddIcecreamForm, _React$Component);

	function AddIcecreamForm() {
		_classCallCheck(this, AddIcecreamForm);

		return _possibleConstructorReturn(this, (AddIcecreamForm.__proto__ || Object.getPrototypeOf(AddIcecreamForm)).apply(this, arguments));
	}

	_createClass(AddIcecreamForm, [{
		key: "createIcecream",
		value: function createIcecream(event) {}
	}, {
		key: "render",
		value: function render() {
			...
			return _react2.default.createElement(
				"form",
				{ className: "icecream-form", onSubmit: function onSubmit(e) {
						return _this2.goToStore(e);
					} },
				...
				_react2.default.createElement("input", { type: "text", placeholder: "image" }),
				_react2.default.createElement(
					"button",
					{ type: "submit" },
					" + Add Item "
	...
	return AddIcecreamForm;
}(_react2.default.Component);

exports.default = AddIcecreamForm;
...
var Shoppe = function (_React$Component) {
	_inherits(Shoppe, _React$Component);

	function Shoppe() {
		_classCallCheck(this, Shoppe);

		return _possibleConstructorReturn(this, (Shoppe.__proto__ || Object.getPrototypeOf(Shoppe)).apply(this, arguments));
	}
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					{ className: 'menu' },
					_react2.default.createElement(_header2.default, { tagline: 'black ice-cream is so last year' })
				),
...
exports.default = Shoppe;

},{"../components/header":2,"../components/inventory":4,"../components/order":5,"react":38}],4:[function(require,module,exports){
'use strict';
...
var _addIcecreamForm = require('../components/addIcecreamForm');

var _addIcecreamForm2 = _interopRequireDefault(_addIcecreamForm);
	...
	_createClass(Inventory, [{
		...
		value: function render() {
			return _react2.default.createElement(
				'div',
				{ className: 'inventory' },
				_react2.default.createElement('img', { src: '/public/images/ice-cream-cup-clipart-ncBXLbMei.png' }),
				_react2.default.createElement(_addIcecreamForm2.default, null)
			);
		}
	}]);
...
},{"../components/addIcecreamForm":1,"react":38}],5:[function(require,module,exports){
"use strict";
